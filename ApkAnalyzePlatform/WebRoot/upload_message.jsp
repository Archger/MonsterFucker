						...
						<div id="analysis" class="section scrollspy">
							...
							<div class="row">
								<div class="col s12">
									...
									<a href="showpage1?pageNo = 1">首页</a>
									<c:choose>
										<c:when test="${pag.pageno gt 1 }">
											<a href="showpage1?pageNo=${pag.pageno-1}">上一页</a>
										</c:when>
										<c:otherwise>
									...
									<c:choose>
										<c:when test="${pag.pageno lt pag.totalpage }">
											<a href="showpage1?pageNo=${pag.pageno+1}">下一页</a>
										</c:when>
										<c:otherwise>
											<a href="javascript:alert('已经是最后一页')">下一页</a>
										</c:otherwise>
									</c:choose>
									<a href="showpage1?pageNo=${pag.totalpage}">末页</a>
									&nbsp;&nbsp; 共${pag.totalcount } 条
								</div>
										</div>
									</div>
